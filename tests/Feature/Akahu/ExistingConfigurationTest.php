...
class ExistingConfigurationTest extends TestCase
{
    ...
    public function test_akahu_upload_partial_does_not_render_sensitive_fields(): void
    {
    ...
    public function test_akahu_configure_partial_renders_pending_transaction_option(): void
    {
        $html = view('import.004-configure.partials.akahu-options', [
            'configuration' => Configuration::fromArray(['flow' => 'akahu']),
        ])->render();

        $this->assertStringContainsString('name="pending_transactions"', $html);
    }
}
